 ...
 export class WebRTCAdaptor
 {
	 ...
	 getUserMedia(mediaConstraints, audioConstraint, streamId) 
	 {
		 ...
		 if(this.publishMode == "screen+camera" || this.publishMode == "screen"){
			 let display_mediaConstraints = {
				 video : true,
				 audio : true
			 };
			 display_mediaConstraints.frameRate = this.mediaConstraintsFrameRate;
			 navigator.mediaDevices.getDisplayMedia(display_mediaConstraints)
			 .then(stream =>{
				 resetTrack(stream);
